...
<head>
  ...
  <style>
    .jumbotron {
      padding-top: 7rem;
      margin-bottom: 0;
      background: #663fb5 url('https://wallpapercave.com/wp/wp45992.jpg') no-repeat center bottom;
...
<body>
  ...
  <header class="jumbotron bg-inverse text-xs-center center-vertically" role="banner">
    <div class="container">
      <h1 class="display-3">Sistem Informasi<br>Aplikasi Laundry</h1>
      <h2 class="m-b-3">Bersih, <em>Wangi</em>, dan Ekonomis <br><a href="ui-elements.html" class="jumbolink">powered by TBR</a>.</h2>
      <a class="btn btn-secondary-outline m-b-1" href="#" role="button"><span class="icon-sketch"></span>PESAN SEKARANG</a>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-7">
          <ul class="nav nav-inline">
            <li class="nav-item">
              <a class="nav-link" href="">Tugas Aplikasi Mobile UNIDAYAN<span class="sr-only"></span></a>
            </li>
          </ul>
        </div>
      </div>
